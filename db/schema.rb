...
ActiveRecord::Schema[7.0].define(version: 2023_08_15_163543) do
  ...
  create_table "operation_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_operation_categories_on_category_id"
    t.index ["operation_id"], name: "index_operation_categories_on_operation_id"
  end
